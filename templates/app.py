...
# app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////mnt/c/Users/Zodia/OneDrive/Desktop/emedic/emedic/medic.db'
...
#       #  user = users(userid)
#        db.session.add(Users(user_id=userid,email=email,type=typ,password=passw))
#        db.session.commit()
